...
<head>
    ...
    <meta name="description" content="Haipath te ayuda a encontrar boticas, restaurantes, hoteles, grifos,  mecánicos, etc…  de forma más precisa haciendo que tu tiempo sea más valioso en la ciudad donde te estés. ">
    <meta name="author" content="Silvacorp">
    ...
    <div class="nav-top">
        ...
        <ul class="nav navbar-left">
            <li class="tooltip-sidebar-toggle">
                <a href="#" id="sidebar-toggle" data-toggle="tooltip" data-placement="right" title="Mostrar todo el mapa">
...
<li class="side-user hidden-xs">
    ...
    <p class="name tooltip-sidebar-logout">
        ...
        <span class="last-name">{{ Auth::user()->apellidos }}</span> <a style="color: inherit" class="logout_open" href="#logout"
                                                data-toggle="tooltip" data-placement="top" title="Cerrar Sesion"><i
...
@section('content')
                ...
                $.ajax({
                    ...
                    success: function (clinicas) {
                        ...
                        for (var i=0 ; i < clinicas.length; i++ ) {
                            ...
                            var icono = 'http://201.230.220.121/negocios/assets/img/puntos/'+clinicas[i]['icono'];
                            //console.log(icono);
                            ...
                            marcador.content =
                                '<div class="container-fluid">' +
									'<label aling="center">'+clinicas[i]['tipo']+' '+clinicas[i]['descripcion']+'</label> </br>' +
									'<label>Direccion : </label>' + clinicas[i]['direccion'] + '</br>' +
                                    '<div class="1"><img class="img-datoinformativo" src="http://201.230.220.121/negocios/assets/img/' + clinicas[i]['urlimagen']+ '?sz=35" style="">'+
									'</div>'+
									'<div class="2">'+
									'<label> Contacto  : </label>' + clinicas[i]['nombres']+ 
									'</div>'+
                                    '</div>';
        ...
        <div class="row" id="content">
             <div id="map_canvas" class="table-responsive" style="width: 750dpi;height: 600px">
        </div>
        </div>
