...
<head>
	...
	<link rel="SHORTCUT ICON" href="/assets/img/fb_icon_325x325.png"> 
	
	
    <title>¡Bienvenido a haipath en Español!</title>
    {{-- GLOBAL STYLES --}}
...
<body class="login">
    <div class="barra"><div class="logohaipath"><strong class="nombre">haipath</strong></div></div>
@section('content')
